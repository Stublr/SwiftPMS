...
export function RoomsPage() {
  ...
  async function fetchRooms(ci: string, co: string) {
    ...
    setError(null);
    try {
      const result = await checkAvailability(ci, co);
      setRooms(result);
    } catch (err) {
      setError(
  ...
  function handleBookNow(roomTypeId: string) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      {hasDates ? (
        ...
        /* No dates selected — show date picker */
          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                min={
                  localCheckIn
                    ? new Date(new Date(localCheckIn).getTime() + 86400000)
                        .toISOString()
                        .split("T")[0]
                    : today
                }
      ...
      {/* Room Cards */}
      {!loading && hasDates && rooms.length === 0 && !error && (
